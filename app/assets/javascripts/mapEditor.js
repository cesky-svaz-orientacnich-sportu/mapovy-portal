...
function setupMap(mapElement, useScrollWheel) {
	...
	const zoom = Config.mapInitParams.zoom;
	const lat = Config.mapInitParams.lat;
	const lng = Config.mapInitParams.lng;
	const mapTypeId = Config.mapInitParams.mapTypeId;

	const getShcTile = new google.maps.ImageMapType({
